...
class OutroValor:
    def __init__(self, id: int, data: str, nome: str,  tipo: str, forma_pgto: str, valor: float, observacao: str):
        self.id = id
        self.data = data
        self.nome = nome
        self.tipo = tipo
    ...
    def __repr__(self):
        return (
            ...
            f"tipo='{self.tipo}', forma pgto={self.forma_pgto}, valor={self.valor}, observacao={self.observacao})"
        )
